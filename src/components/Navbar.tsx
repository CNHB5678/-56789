...
import { Menu, X, User, LogOut, MessageSquare, Users, Search, Cpu, LogIn } from 'lucide-react';
...
const Navbar = () => {
  ...
  const handleLoginSuccess = () => {
    ...
    setUser({
      id: '1',
      username: '测试用户',
      avatar_url: 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=user%20avatar&image_size=square',
      bio: 'AI爱好者',
      level: 1,
      experience: 0,
      online_time: 0,
              ...
              <div className="flex flex-col space-y-3">
                ...
                {!user && (
                  <button 
                    ...
                    className="flex items-center gap-2 px-4 py-3 rounded-lg bg-secondary-500 hover:bg-secondary-600 transition-colors w-full"
                  >
                    <LogIn size={16} />
                    <span>登录</span>
                  </button>
